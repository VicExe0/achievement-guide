...
export const GameFrame = forwardRef( function <T extends ElementType = "div">(props: Props<T>, ref: React.Ref<any> ) {
    ...
    return (
      <Component to={href} ref={ref} {...rest}>
          <div className="w-full h-full max-w-[200px] max-h-[300px] transition-transform transform-gpu duration-300 ease-out hover:-translate-y-1 hover:scale-101 hover:-rotate-x-3 hover:shadow-2xl">
              {children}
          </div>
      </Component>
    );

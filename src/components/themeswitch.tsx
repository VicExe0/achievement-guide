...
export const ThemeSwitch = () => {
    ...
    return (
        <label className="container max-w-[32px] max-h-[32px] transition-transform duration-200 hover:scale-95">
            <input checked={checked} type="checkbox" onChange={checkboxHadle} />
